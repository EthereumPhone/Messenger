...
fun generateTestMessages(): List<Message> {
    ...
    val now = Instant.parse("2025-04-12T12:23:05Z")
    ...
    return listOf(
        ...
        Message("7", "thread123", recipientOther, now - (54 * 60).seconds, now - (54 * 60).seconds, true, DeliveryStatus.PUBLISHED, null, true, emptyList(), emptyList(), "She said 'it looked funny' and pressed market buy 🤷‍♂️"),
